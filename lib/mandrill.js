...
mandrillEmail.acknowledgeSocietyEmail = function(userEmail, userFirstName) {
  ...
  var societyFirstHtmlEmaildata = fs.readFile('./assets/emails/societyfirstemail.txt', {
    encoding: 'utf-8'
    ...
    return societyFirstHtmlEmaildata;
  });

  var societySecondHtmlEmaildata = fs.readFile('./assets/emails/societysecondemail.txt', {
    encoding: 'utf-8'
    ...
    return societySecondHtmlEmaildata;
  });


  if (counter === 2) {
    console.log('counter', counter);
    console.log('societyFirstHtmlEmaildata', societyFirstHtmlEmaildata);
    console.log('societySecondHtmlEmaildata', societySecondHtmlEmaildata);
    params = {
      "message": {
