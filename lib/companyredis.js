    ...
    var companyDatabase = function(request, reply) {
        ...
        var thisId = client.incr('id', function(err, reply) {
            ...
            if (err) {
             ...
             // var quoteData = {
             //      message : "Thank you for registering your details, we'll be in contact shortly",
             //      showclass :'show',
             //      hideclass :'hide'
             //  };
             //  console.log('QD', quoteData);
             //var quote = template.buildQuote(quoteData);
              
             setTimeout(function(){ return reply.view('company');}, 1000000);
