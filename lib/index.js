...
var Adminpassword = require('./password.js');
...
exports.init = function (port, next) {
  ...
  server.register([Inert, Vision, Assets, Home, Favicon, Companyredis, Societyredis, Autocomplete, Admin, Adminpassword, Societydashboard, Companydashboard, Deletesociety, Deletecompany, Societydashboardsearch, Companydashboardsearch], function (err) {
