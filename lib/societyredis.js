  ...
  var societyDatabase = function(request,reply){
    ...
    societyFormObjectKeys.forEach(function(elem, i){
      ...
      regEx.exec(societyFormObject[elem.toString()]) === null
          ...
          // console.log("regEx.exec(societyFormObject[elem]", regEx.exec(societyFormObject[elem]));
          // console.log("before regEX", societyFormObject[elem]);
          societyFormObject[elem.toString()] = "";
      }
    });
    console.log("after regEx", societyFormObject);
